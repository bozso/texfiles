...
\begin{frame}{\ft}
    \begin{minipage}[c]{0.475\textwidth}
        \inc{insar/theory/phase_unwrapping.jpg}
    \end{minipage}
    \begin{minipage}[c]{0.475\textwidth}
        \inc{insar/theory/unwrap1.png}
    \end{minipage}
    \vspace{10pt}
    \begin{minipage}[c]{0.475\textwidth}
    \begin{itemize}
    ...
    \end{minipage}
    \begin{minipage}[c]{0.475\textwidth}
        \inc{insar/theory/unwrap2.png}
    \end{minipage}
\end{frame}


\begin{frame}{\ft}
    \begin{figp}{\inc{insar/theory/wrapped_and_unwrapped_ifg.jpg}}{}{0.6}{0.35}
        \begin{itemize}
