...
\begin{frame}{\ft}
    \begin{figp}{\inc{insar/theory/insar_phase.png}}{}{0.675}{0.3}
...
\begin{frame}{\ft}
    \begin{minic}{0.6}
        \inc{insar/theory/ifg_flattening.png}
        \centering
...
% Zolitól ábra, példa számokkal, height ambiguity, error -- baseline
\begin{frame}{\ft}
    \begin{figp}{\inc{insar/theory/burgmann_geom.png}}{Két SAR felvétel geometriája \cite{BurgmannInSAR}}{0.4}{0.5}
        \begin{itemize}
            ...
            \item magassági \quo{bizonytalanság} (height ambiguity):
...
\begin{frame}{\ft}
    \only<1>{
    \begin{minic}{0.70}
        \inc{insar/theory/hooper_topo_1.png}
    \end{minic}
    }
    \only<2>{
    \begin{minic}{0.70}
        \inc{insar/theory/hooper_topo_2.png}
    \end{minic}
    }
    \centering
...
\begin{frame}{Fázistagok ``érzékenysége''}
    ...
    \begin{minipage}[b]{0.45\textwidth}
        \inc{insar/theory/deform.png}
        \centering
        
    \end{minipage}
    \hspace{10pt}
    \begin{minipage}[b]{0.45\textwidth}
        \inc{insar/theory/baseline_vs_topo_ambig.png}
        \centering
