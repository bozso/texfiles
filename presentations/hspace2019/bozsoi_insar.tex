...
\begin{frame}{Processing the interferometric phase}
    ...
    \begin{itemize}
        ...
        %\item spatial filtering Goldstein-filter \footfullcite{ZebkerGoldstein1986}
        \item spatial filtering Goldstein-filter \autocite{ZebkerGoldstein1986}
    \end{itemize}
\end{frame}
...
\begin{frame}{\ft}
    \begin{itemize}
        ...
        \item robust method developed by REF based on REF:
        \[
