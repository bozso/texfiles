...
\begin{frame}{\ft}
    \begin{itemize}
        ...
        \item SAR images processed with the Gamma Software REF
    \end{itemize}
\end{frame}
...
\begin{frame}{\ft}
    ...
    Clear trend of linear movement away from the satellite.    
    \end{center}
\end{frame}
...
\begin{frame}{\ft}
    \begin{center}
        ...
        Similar time-series for all 3 moving reflectors, subsidence and movement towards east, the Danube.
    \end{center}
\end{frame}
...
\begin{frame}{\ft}
    \begin{itemize}
        ...
        \item filtering IFG creating high and low sub-band IFGs,  $\dtec$ is proportional to sub-band IFG phase differences
        \item robust method developed by ref:
        \[
