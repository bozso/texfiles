...
\begin{frame}{A szubdukálódó lemez és a szubdukciós zóna sematikus felépítése}
    ...
    \begin{minipage}[c]{0.88\textwidth}
        \ffig{subduction_schematic_color.png}
    \end{minipage}
    \end{center}
\end{frame}
