...
- setting up of the National Committee for ILP in the framework of the Romanian Academy
- participation in ILP Business meting in Vienna, April 2017; NIEP and GGKI new members; meeting board members of ILP
- CNISS cofnerence - Bucharest, June 2017
- Romania - Hungary, InterReg proposal
- seismicity monitoring in the Topo-Transylvania area
- testing multiple discrimination techniques for earthquakes, cleaning up Romanian catalog
...
- **quarry events**
    - explosion generates high frequencies
    - high and low frequencies, 0.5 - 3 Hz filtering
...
- **geospatial data**
    ...
    - coop. with Institute for Optoelectrics (M. Zoran), earthquake precursors
    - space-based + surface in-situ osbervations, earthquake prone areas
    - precursor crustal displacements
    - Sentinel-1 time series, Vrancea, 2014.10. - 2016.10.
    - 5-10 mm/yr displacement velocities

### InSAR - Eszter Szűcs

- gas storage monitoring with InSAR?, sandstone
...
- **scatterers**: Ciomadul and Praid salt diapir
    - Ciomadul
        - find secure places for reflectors, 3 found, 1 not so secure; private property and natural protection area
        - other optional places
    - Praid
        - 2 secure places, private property
- seismic arrays (INFP)
- **sampling**: South Harghita shoshonites
    - post emplacement minerals
    - 1.6 Ma old, probably younger?
    - cavities, enclaves
- **What's next:**
    ...
    - prepare future deployment of the Hungarian Seismic Array
...
- maps of residual anomalies
    ...
    - gravity and magnetic anomalies &rarr; separation of the volcanic chain
...
- alkaline-basaltic volcanoes - they are in the wrong place at the wrong time
- source region: **300 to 1000 ppm, very high**; 2x, 4x the global average
- Message:
    - upper mantle must have been in a partially molten state, melt < 1 volume %
    - seismic anisotropy &harr; volcanic lines
...
- receiver functions: impulse response of the crust &rarr; v<sub>p</sub> / v<sub>s</sub> and depth of Moho, good for looking at sharp velocity changes, bad for: knowing about absolute velocities
- v<sub>p</sub> / v<sub>s</sub> analogous to Poisson ratio &rarr; bulk crustal composition
...
- GPS vertical vel., Iberian-peninsula, intramountain basins an enigma &larr; lithosphere folding
...
- today's agenda by Eszter Szűcs
...
- in Covasna area
- not recommended to switch instruments during the monitoring period
...
- meteorological station needed - Thomas Lange
...
#### Praid (Parajd) salt diapir

- Praid, 2014 fall - 2018 summer, Sentinel-1 descending track
LOS deformation velocities
- salt valley $\approx 5 \hspace{2.5pt} \text{cm} \hspace{1.25pt} \text{yr}^{-1}$ movement away from satellite, probably from erosion of the salt surface
- István Horváth, salt mine geologist; contact; maps, pictures sent by him
- dolinas under new mine
- additional reflectors to be installed?
...
- young geological processes: basin formation, subduction roll-back and break-off
volcanism, post volcanic activity

### Research area

- magnetotelluric stations 70-80 km away from each other
- planned stations near the Persani Mountains
    - conductivity distribution &harr; post-volcanic activity
...
- inversion to retrieve resistivity-depth function
...
- induction arrows coherently point towards east, conducting body?
    ...
    - combine data with romanian colleagues
...
- compare the fluids in the mantle xenoliths 

- seismicity distribution in Vrancea
    - two peaks (90 km and 130 km), gap between them
    - joint publication - seismicity and geochemistry
...
- Vrancea: oceanic subduction, detachment &harr; lithospheric delamination
...
- goals:
    ...
    - identify fundamental frequency of resonance along the Pannonian Basin
    - interpretation  
- dataset:
...
- results
    ...
    - second higher mode
        - characterized by very shallow sediments
...
- surface salt rock on the surface - karstic
...
#### Downtown
- CO<sub>2</sub> buildup &rarr; mud eruptions
- CO<sub>2</sub> erodes the concrete away in the square
- hotel - earthquake  &rarr; shift in the building

### Measured CO<sub>2</sub>
- Praid: ~450-530 ppm
- Persani: 450 ppm; largest: ~1460 ppm
- Covasna points: 630 ppm, 432 ppm; Hankó valley: >2000 ppm 

### Questions
- relation of CO<sub>2</sub> to volcanism
